...
// Sustainability is now detected directly from Amazon's Climate Pledge Friendly
...
async function getAlternativeProducts(currentPrice) {
  ...
  // Mock CPF-verified alternatives — replace with real DB query
  // e.g. SELECT * FROM products WHERE cpf=true AND price BETWEEN min AND max
  const mockDB = [
